...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Xiaowei9904@".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["wks9904.x3322.net"];
pub const RS_PUB_KEY: &str = "vKXXCf9ry0uFuZ6UTb3k454ISHc6p7jkPVXkD0YnpDk=";
